...
let products = [
  {
    ...
    price: "15$",
    "product-image":
      "\\public\\images\\severin-candrian-gTMnUAkPvlQ-unsplash.jpg",
  },
  {
    name: "golden pothos",
    price: "15$",
  ...
  },
  {
    ...
    price: "20$",
    "product-image":
      ".\\images\\gabriella-clare-marino-m7Gos2-mS-A-unsplash.jpg",
  },
  {
    name: "snake plant",
    price: "20$",
...
function removeFromCart(event) {
  let removedItemName = event.target
    .closest(".item")
...
function updateQuantity(event) {
  ...
  let cart = JSON.parse(localStorage.getItem("cart"));
  let item =
    cart[event.target.closest(".item").querySelector(".name").innerText];
  console.log(item);
